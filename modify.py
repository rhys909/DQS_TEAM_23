...
answers={}
class modify (Frame):
    with open('exams/exam1.csv', 'r') as csvFile:#<<<<<<<<<<<<<<<<<<<<<Type the exam file name you want to modify
    ...
    def init_window(self):
        ...
        def save():
            ...
            with open('exams/exam1.csv','w',newline='') as f:#<<<<<<<<<<<Type the exam file name you want to modify
